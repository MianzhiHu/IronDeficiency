...
psychopathology = ['PARS_AnxSymptCt', 'PARS_AnxSymptFreq', 'PARS_AnxSeverity', 'PARS_AnxPhysSymptSeverity',
                   ...
                   'SCARED_C_GAD_Score', 'SCARED_C_PanicD_Score', 'SCARED_C_SocialPhob_Score',
                   'SCARED_C_SchoolPhob_Score', 'SCARED_C_SeparationAnx_Score', 'SCARED_P_GAD_Score',
                   ...
                   'CBCL_internal_T_SCORE', 'CBCL_external_T_SCORE', 'CBCL_Activities__T_SCORE',
                   'CBCL_Social_T_SCORE', 'CBCL_edu_T_SCORE', 'CBCL_DSM_DepProb_T_SCORE', 'CBCL_DSM_AnxProb_T_SCORE',
                   'CBCL_DSM_SomaProb_T_SCORE', 'CBCL_DSM_AttenDef_T_SCORE', 'CBCL_DSM_OppDefProb_T_SCORE',
                   'CBCL_DSM_CondProb_T_SCORE', 'CBCL_Scale_SluggCog_T_SCORE', 'CBCL_Scale_ObsesComp_T_SCORE',
                   'CBCL_Scale_StressProb_T_SCORE']
